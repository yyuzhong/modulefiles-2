...
local release = "/composer_xe_2015.1.133"
...
local trapath = pathJoin(basedir, ver .. sub, "/itac/9.0.2.045/intel64/bin")
local tralib  = pathJoin(basedir, ver .. sub, "/itac/9.0.2.045/intel64/slib")
local tramlib = pathJoin(basedir, ver .. sub, "/itac/9.0.2.045/intel64/mic/slib")
local traman  = pathJoin(basedir, ver .. sub, "/itac/9.0.2.045/man")

-- Export path and man paths
prepend_path("PATH",    binpath)
prepend_path("MANPATH", manpath)
prepend_path("PATH",    trapath)
prepend_path("MANPATH", traman)
...
prepend_path("LD_LIBRARY_PATH", tralib)
prepend_path("LD_LIBRARY_PATH", tramlib)
...
prepend_path("LIBRARY_PATH", tralib)
prepend_path("LIBRARY_PATH", tramlib)
